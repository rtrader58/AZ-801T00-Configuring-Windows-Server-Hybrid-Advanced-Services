...
Step 4:  Paste cmdlet into Notepad or the PowerShell ISE, replace '<WorkspaceID>'  with "WorkspaceID copied in previous step" and  'Primarykey'  with "PrimaryKey copied in previous step" remove the < and > ensure you keep the " at the beginning and the end of each paste - then copy and paste from Notepad or the PowerShell ISE into the Cloud Shell<br>
