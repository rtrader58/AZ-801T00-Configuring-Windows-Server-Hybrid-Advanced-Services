...
Step 4:  Paste cmdlet into Notepad or the PowerShell ISE, replace "<WorkspaceID>" with "WorkspaceID copied in previous step" and "<PrimaryKey>" with "PrimaryKey copied in previous step" - then copy and paste from Notepad or the PowerShell ISE into the Cloud Shell<br>
